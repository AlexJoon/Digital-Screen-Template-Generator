  ...
  return (
    <div className="space-y-2">
      ...
      {!value && !isProcessing ? (
        ...
        <div className="flex items-center space-x-4 p-6 bg-white border border-gray-300 rounded-lg">
          <svg className="animate-spin h-8 w-8 text-[#009bdb]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
